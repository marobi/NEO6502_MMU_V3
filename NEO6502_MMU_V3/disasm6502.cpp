...
enum AddrMode {
  IMP, ACC, IMM, ZP, ZPX, ZPY, ABS, ABSX, ABSY, IND, INDX, INDY, ZPIND, REL, ZPREL, ABXI
};
...
static const Opcode optable[256] PROGMEM = {
  ...
  {"PHP",IMP,1},{"ORA",IMM,2},{"ASL",ACC,1},{"???",IMP,1},{"TSB",ABS,3},{"ORA",ABS,3},{"ASL",ABS,3},{"BBR0",ZPREL,3},

  {"BPL",REL,2},{"ORA",INDY,2},{"ORA",ZPIND,2},{"???",IMP,1},{"TRB",ZP,2},{"ORA",ZPX,2},{"ASL",ZPX,2},{"RMB1",ZP,2},
  {"CLC",IMP,1},{"ORA",ABSY,3},{"INC",ACC,1},{"???",IMP,1},{"TRB",ABS,3},{"ORA",ABSX,3},{"ASL",ABSX,3},{"BBR1",ZPREL,3},

  {"JSR",ABS,3},{"AND",INDX,2},{"???",IMP,1},{"???",IMP,1},{"BIT",ZP,2},{"AND",ZP,2},{"ROL",ZP,2},{"RMB2",ZP,2},
  {"PLP",IMP,1},{"AND",IMM,2},{"ROL",ACC,1},{"???",IMP,1},{"BIT",ABS,3},{"AND",ABS,3},{"ROL",ABS,3},{"BBR2",ZPREL,3},

  {"BMI",REL,2},{"AND",INDY,2},{"AND",ZPIND,2},{"???",IMP,1},{"BIT",ZPX,2},{"AND",ZPX,2},{"ROL",ZPX,2},{"RMB3",ZP,2},
  {"SEC",IMP,1},{"AND",ABSY,3},{"DEC",ACC,1},{"???",IMP,1},{"BIT",ABSX,3},{"AND",ABSX,3},{"ROL",ABSX,3},{"BBR3",ZPREL,3},

  {"RTI",IMP,1},{"EOR",INDX,2},{"???",IMP,1},{"???",IMP,1},{"???",IMP,1},{"EOR",ZP,2},{"LSR",ZP,2},{"RMB4",ZP,2},
  {"PHA",IMP,1},{"EOR",IMM,2},{"LSR",ACC,1},{"???",IMP,1},{"JMP",ABS,3},{"EOR",ABS,3},{"LSR",ABS,3},{"BBR4",ZPREL,3},

  {"BVC",REL,2},{"EOR",INDY,2},{"EOR",ZPIND,2},{"???",IMP,1},{"???",IMP,1},{"EOR",ZPX,2},{"LSR",ZPX,2},{"RMB5",ZP,2},
  {"CLI",IMP,1},{"EOR",ABSY,3},{"PHY",IMP,1},{"???",IMP,1},{"???",IMP,1},{"EOR",ABSX,3},{"LSR",ABSX,3},{"BBR5",ZPREL,3},

  {"RTS",IMP,1},{"ADC",INDX,2},{"???",IMP,1},{"???",IMP,1},{"STZ",ZP,2},{"ADC",ZP,2},{"ROR",ZP,2},{"RMB6",ZP,2},
  {"PLA",IMP,1},{"ADC",IMM,2},{"ROR",ACC,1},{"???",IMP,1},{"JMP",IND,3},{"ADC",ABS,3},{"ROR",ABS,3},{"BBR6",ZPREL,3},

  {"BVS",REL,2},{"ADC",INDY,2},{"ADC",ZPIND,2},{"???",IMP,1},{"STZ",ZPX,2},{"ADC",ZPX,2},{"ROR",ZPX,2},{"RMB7",ZP,2},
  {"SEI",IMP,1},{"ADC",ABSY,3},{"PLY",IMP,1},{"???",IMP,1},{"JMP",ABXI,3},{"ADC",ABSX,3},{"ROR",ABSX,3},{"BBR7",ZPREL,3},

  {"BRA",REL,2},{"STA",INDX,2},{"???",IMP,1},{"???",IMP,1},{"STY",ZP,2},{"STA",ZP,2},{"STX",ZP,2},{"SMB0",ZP,2},
  {"DEY",IMP,1},{"BIT",IMM,2},{"TXA",IMP,1},{"???",IMP,1},{"STY",ABS,3},{"STA",ABS,3},{"STX",ABS,3},{"BBS0",ZPREL,3},

  {"BCC",REL,2},{"STA",INDY,2},{"STA",ZPIND,2},{"???",IMP,1},{"STY",ZPX,2},{"STA",ZPX,2},{"STX",ZPY,2},{"SMB1",ZP,2},
  {"TYA",IMP,1},{"STA",ABSY,3},{"TXS",IMP,1},{"???",IMP,1},{"STZ",ABS,3},{"STA",ABSX,3},{"STZ",ABSX,3},{"BBS1",ZPREL,3},

  {"LDY",IMM,2},{"LDA",INDX,2},{"LDX",IMM,2},{"???",IMP,1},{"LDY",ZP,2},{"LDA",ZP,2},{"LDX",ZP,2},{"SMB2",ZP,2},
  {"TAY",IMP,1},{"LDA",IMM,2},{"TAX",IMP,1},{"???",IMP,1},{"LDY",ABS,3},{"LDA",ABS,3},{"LDX",ABS,3},{"BBS2",ZPREL,3},

  {"BCS",REL,2},{"LDA",INDY,2},{"LDA",ZPIND,2},{"???",IMP,1},{"LDY",ZPX,2},{"LDA",ZPX,2},{"LDX",ZPY,2},{"SMB3",ZP,2},
  {"CLV",IMP,1},{"LDA",ABSY,3},{"TSX",IMP,1},{"???",IMP,1},{"LDY",ABSX,3},{"LDA",ABSX,3},{"LDX",ABSY,3},{"BBS3",ZPREL,3},

  {"CPY",IMM,2},{"CMP",INDX,2},{"???",IMP,1},{"???",IMP,1},{"CPY",ZP,2},{"CMP",ZP,2},{"DEC",ZP,2},{"SMB4",ZP,2},
  {"INY",IMP,1},{"CMP",IMM,2},{"DEX",IMP,1},{"WAI",IMP,1},{"CPY",ABS,3},{"CMP",ABS,3},{"DEC",ABS,3},{"BBS4",ZPREL,3},

  {"BNE",REL,2},{"CMP",INDY,2},{"CMP",ZPIND,2},{"???",IMP,1},{"???",IMP,1},{"CMP",ZPX,2},{"DEC",ZPX,2},{"SMB5",ZP,2},
  {"CLD",IMP,1},{"CMP",ABSY,3},{"PHX",IMP,1},{"STP",IMP,1},{"???",IMP,1},{"CMP",ABSX,3},{"DEC",ABSX,3},{"BBS5",ZPREL,3},

  {"CPX",IMM,2},{"SBC",INDX,2},{"???",IMP,1},{"???",IMP,1},{"CPX",ZP,2},{"SBC",ZP,2},{"INC",ZP,2},{"SMB6",ZP,2},
  {"INX",IMP,1},{"SBC",IMM,2},{"NOP",IMP,1},{"NOP",IMP,1},{"CPX",ABS,3},{"SBC",ABS,3},{"INC",ABS,3},{"BBS6",ZPREL,3},

  {"BEQ",REL,2},{"SBC",INDY,2},{"SBC",ZPIND,2},{"???",IMP,1},{"???",IMP,1},{"SBC",ZPX,2},{"INC",ZPX,2},{"SMB7",ZP,2},
  {"SED",IMP,1},{"SBC",ABSY,3},{"PLX",IMP,1},{"???",IMP,1},{"???",IMP,1},{"SBC",ABSX,3},{"INC",ABSX,3},{"BBS7",ZPREL,3}
};
...
/// <summary>
/// read memory for finding label locations (1st pass)
/// </summary>
/// <param name="addr"></param>
...
uint16_t disasm6502(uint16_t addr, const uint16_t lines, const bool simple) {
  ...
  for (uint16_t line = 0; line < lines; line++) {
    ...
    case ABXI:
      Serial1.printf("($%02X%02X,X)", b[2], b[1]);
      break;

    case ZPREL: {
      uint16_t t = addr + 3 + (int8_t)b[2];
      const char* l = findLabel(t);
      Serial1.printf("$%02X,", b[1]);
      if (l) Serial1.printf("%s", l);
      else   Serial1.printf("$%04X", t);
      break;
    }
